...
import cc.jweb.boot.utils.lang.*;
...
public class FileUtils {
     ...
     */
    public static boolean moveFileWithProgress(String source, String target, ProgressListener listener) throws IllegalArgumentException, IOException {
     ...
     * @throws NoSuchFileException      源文件不存在，源文件不是个文件(可能是文件夹)
     */
    public static boolean copyFileWithProgress(String source, String target, ProgressListener listener) throws IllegalArgumentException, IOException {
        Assert.notBlank(source, "源文件路径不能为空");
        Assert.notBlank(target, "目标文件路径不能为空");
...
//            Console.err(StringUtils.concat("文件[", file.getPath() + "]删除失败"));
     ...
     * @throws IOException              IOException
     */
    private static boolean moveFile(String source, String target) throws IOException, IllegalArgumentException {
     ...
     * @throws IOException              IOException
     */
    private static boolean moveFolder(String source, String target) throws IOException, IllegalArgumentException {
     ...
     * @throws IOException              IOException
     */
    private static boolean copyFile(String source, String target) throws IOException, IllegalArgumentException {
     ...
     * @throws IOException              IOException
     */
    private static boolean copyFolder(String source, String target) throws IOException, IllegalArgumentException {
