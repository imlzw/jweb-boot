 ...
 * ant path 路径匹配器
 */
public class JwebAntPathMatcher implements PatternMatcher{
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = JwebAntStringUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = JwebAntStringUtils.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = JwebAntStringUtils.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = JwebAntStringUtils.tokenizeToStringArray(path, this.pathSeparator);
