...
package cc.jweb.boot.aop;

import cc.jweb.boot.aop.cglib.JwebCglibProxyFactory;
 ...
 * AOP依赖注入工厂
 */
public class JwebAopFactory extends AopFactory {
    ...
    private static JwebAopFactory me = new JwebAopFactory();


    public static JwebAopFactory me() {
        return me;
    }
    ...
    private JwebAopFactory() {
        ProxyManager.me().setProxyFactory(new JwebCglibProxyFactory());
